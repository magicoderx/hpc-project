...
int main(){
    ...
    h_data   = (DATA_TYPE*) malloc(m * n * sizeof(DATA_TYPE));
    h_mean   = (DATA_TYPE*) malloc(m * sizeof(DATA_TYPE));
    h_stddev = (DATA_TYPE*) malloc(m * sizeof(DATA_TYPE));
    h_symmat = (DATA_TYPE*) malloc(m * m * sizeof(DATA_TYPE));
